...
4. Check that you are on the correct (new) Fedora release. Do this check only after completing the download-installation phase of clone conversion from old to new.
    ```
